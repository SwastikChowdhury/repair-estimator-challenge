// AUTO-GENERATED from Pricing_List__1_.csv — the single source of truth for pricing.
// Do NOT hand-edit costs. 108 items. Columns: id, name, cost, unit.
const REPAIR_ITEMS = [
